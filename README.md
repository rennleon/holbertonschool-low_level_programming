...
<h2>
	<a href="0x02-functions_nested_loops">0x02. C - Functions, nested loops</a>
</h2>
<details>
<summary>See details</summary>
...
### Learning Objectives
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.hbtn.io/rltoken/V5GIWRLAFBPj4YHdpYiXTw), without the help of Google:
